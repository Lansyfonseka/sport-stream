...
export default function Header() {
  const menu = [
    {
      titel: "הימורים בשידור חי",
      icon: "boll",
      url: "https://heylink.me/PrinceBet77",
    },
    {
      titel: "ספורט אלקטרוני",
      icon: "rocket",
      url: "https://heylink.me/PrinceBet77",
    },
    { titel: "מבצעים", icon: "coins", url: "https://heylink.me/PrinceBet77" },
    {
      titel: "ערוץ מבצעים - טלגרם",
      icon: "diamond",
      url: "https://heylink.me/PrinceBet77",
    },
    {
      titel: "ווטסאפ - הרשמה 24/7",
      icon: "cash",
      url: "https://heylink.me/PrinceBet77",
    },
  ];
  ...
  return (
    <header className="s-header" data-sticky>
      ...
      <div className="s-header__menu">
        ...
        <div className="s-header__menu_item"></div>
      </div>
    </header>
  );
}
